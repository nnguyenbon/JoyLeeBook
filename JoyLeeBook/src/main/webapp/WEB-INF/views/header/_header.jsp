...
<header id="header" class="main-header p-3 d-flex align-items-center justify-content-center">
    <div class="main-context menu-layout">
        <div class="mobile-header <%= pageContext.getAttribute("width")%> d-flex align-items-center <%= pageContext.getAttribute("justify")%>">
            ...
            <label id="menu-icon" class="menu-icon <% if (pageType.equals("login") || pageType.equals("register")) {%> <%= pageContext.getAttribute("display")%> <% } %> text-white fa-2x">&#9776;</label>
        </div>

        <div id="menu" class="menu w-100 <% if (pageType.equals("login") || pageType.equals("register")) {%> <%= pageContext.getAttribute("display")%> <% } %>">
